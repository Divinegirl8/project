    ...
    return (
        ...
        <div className={`cursor-none bg-gradient-to-b from-black via-black to-transparent lg:pb-[15rem] pb-[45rem]  relative  ${style.mainBox}`} ref={ref}>
            <div className="">
                ...
                <div className={`border-gray-500 border-[0.5px] lg:w-[21rem] h-[39rem] mt-5  px-2 mx-5 lg:px-0 rounded-[20px] lg:left-5 lg:top-[10px] lg:my-[5rem] sm:mx-[2rem] lg:fixed z-50 ${style.boxIntro}`}>
                   
                   <div className="mt-5 ml-7">
                   <img src={logo} className={`w-[9rem] ${style.myLogo}`} />
                   </div>

                   <div className="flex justify-center mt-7">
                   <img src={pix2} className={`w-[14rem] h-[14rem] rounded-[20px] ${style.myFoto}`} />
                   </div>
                    <h1 className={`text-white text-[20px] text-center mt-10 ${style.myText}`}>divinemercy601@gmail.com</h1>
                    <p className={`text-yellow-600 text-center text-[12px] ${style.copy}`}>© 2024 DivineMercy. All Rights Reserved</p>
                    ...
                    <div className={`lg:flex lg:items-center justify-center mt-16 ${style.butn}`}>
                ...
                <div className={`mr-[22rem] ${style.introduce}`}>
                <div className="flex flex-row gap-2 items-center justify-center border-gray-500 border w-[10rem] h-[30px] rounded-[20px]">
                    ...
                    <p>A Software Engineer</p>
                      ...
                      <div className={`font-normal text-[68px] text-white font-fontInter ml-[7rem] mt-[6rem] ${style.name}`}>
                    <p>
                ...
                <div className="text-white  hidden justify-center  mt-[20rem] lg:flex flex-row gap-16 mr-[10rem]">
                   <div>
                   <h1 className={`lg:text-[70px] text-[40px] text-yellow-600 ${style.ctn}`}>2+</h1>
                   <h4 className={`flex flex-col lg:text-[20px] text-[15px] ${style.yrs}`}>years of coding <span>experience</span> </h4> 
                    </div> 

                    <div>
                   <h1 className={`lg:text-[70px] text-[40px] text-yellow-600 ${style.ctn}`}>8+</h1>
                   <h4 className={`flex flex-col lg:text-[20px] text-[15px] ${style.yrs}`}>completed <span>projects</span></h4> 
                    </div> 
                </div>
